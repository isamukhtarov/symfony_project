...
CKEDITOR.plugins.add("wordcount",
    {
        lang: "en,az,ru", // %REMOVE_LINE_CORE%
        version: "1.17.4",
        ...
        init: function(editor) {
            ...
            function updateCounter(editorInstance) {
                ...
                // Set symbols count for current class
                $(".content-counter").text(charCount);

                // Set color for counter
                if(charCount <= 2000){
                    $(".content-counter").css("color", "rgb(228 155 20)");
                }else{
                    $(".content-counter").css("color", "#008000");
                }
